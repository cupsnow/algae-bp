#------------------------------------
#
mesa3d_DEP=libdrm llvm expat zlib
...
mesa3d_defconfig $(mesa3d_BUILDDIR)/build.ninja: | $(PYVENVDIR) $(BUILDDIR)/mesa3d-meson-aarch64.ini
	$(mesa3d_MESON) setup --cross-file=$(BUILDDIR)/mesa3d-meson-aarch64.ini \
	    ...
	    -Dc_link_args="-L$(BUILD_SYSROOT)/lib -L$(BUILD_SYSROOT)/lib64 -L$(BUILD_SYSROOT)/usr/lib -L$(BUILD_SYSROOT)/usr/lib64" \
	    -Dcpp_args="-I$(BUILD_SYSROOT)/include -I$(BUILD_SYSROOT)/usr/include" \
	    -Dcpp_link_args="-L$(BUILD_SYSROOT)/lib -L$(BUILD_SYSROOT)/lib64 -L$(BUILD_SYSROOT)/usr/lib -L$(BUILD_SYSROOT)/usr/lib64" \
